...
player    : name is_dealer(?)
card_list : type player:references age:references color:references
  type: [Stock(Age), Hand(Player), Board(Player,Color), Influence(Player), Point(Player)]
card_list_item : card_list:references card:references
